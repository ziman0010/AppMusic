...
class MainTabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        let navigationVC = generateViewController(rootViewController: SearchViewController(), image: #imageLiteral(resourceName: "ios10-apple-music-search-5nav-icon"), title: "Search")
